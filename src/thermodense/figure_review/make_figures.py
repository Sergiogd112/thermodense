"""Generate review figures from committed real PCMCI+ results.
...
Regenerate any time:  uv run python -m thermodense.figure_review.make_figures
"""
...
RESULTS = REPO_ROOT / "benchmarks" / "pcmci-methods" / "results" / "real-1" / "local"
...
def main() -> None:
    ...
    for name, fig in figs.items():
        ...
        fig.savefig(
            ...
            bbox_inches="tight",
            metadata={
                "Creator": "thermodense figure-review workbench",
                "CreationDate": None,
                "ModDate": None,
            },
        )
    ...
    captions = {
        "fig-01": (
            ...
            "renderer. (a) primary 42-link graph; (b) links retained under the "
    ...
    for fid, fname in [
        ...
        figures.append({
            ...
            "provenance": {
                ...
                "renderer": "thermodense.figure_review.make_figures",
                "advisory": (
                    "Review rendering; scientific approval remains a human decision."
                ),
            },
        })
